...
const Section4 = () => {
  return (
    <div className='min-h-[350px] text-blue-800 bg-yellow-300 flex  flex-col sm:flex-row justify-between md:flex-row ' >
        <div className='flex flex-col gap-4 m-4 ml-8 justify-start md:text-left text-center md:justify-normal ' >
            <div className='font-[Quella] font-bold text-lg mt-8' >BLOOMING BASKET</div>
            <div className='text-sm'>We help you find <br></br> your dream mango</div>
            ...
            <div className='md:mt-16 text-sm' > 2024 all Rights Reserved to BLOOMING BASKET</div>
        </div>
