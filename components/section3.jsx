    ...
    <Fragment>
        <div className='  py-4  flex flex-col '>
            <div>
                ...
                <div className='text-slate-600 text-md text-center m-3 ' > Order now to make your life more sweet and tastier </div>
            </div>
            <div className='flex justify-center flex-wrap mt-6 '  >
                ...
                <div className='m-auto text-center w-[350px]' >
                    ...
                    <div className='text-slate-600 text-sm mt-2 px-4 text-center' > 2-day or less delivery time, free shipping and an expedited delivery option. </div>
                </div>
                <div className='m-auto text-center w-[350px]' >
